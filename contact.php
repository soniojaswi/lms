            ...
            <div class="d-grid contact-view">
                ...
                <div class="map-content-9">
                    ...
                    <form action="insertdetail.php" method="post">
                        <div class="twice-two">
                            <input type="text" class="form-control" name="uname" id="w3lName" placeholder="Name"
                                required="">
                            <input type="email" class="form-control" name="email" id="w3lSender" placeholder="Email"
                                required="">
                                <input type="number" class="form-control" name="pnumber" id="w3lName" placeholder="mobile number"
                            >
                            <input type="date" class="form-control" name="dob" id="w3lName" placeholder="date of birth"
                            >
                        </div>
                        <div class="twice">
