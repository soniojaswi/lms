        ...
        <div class="widget-shadow">
            <div class="login-body">
                <form action="checklogin.php" method="post">
                    <input type="password" class="lock" name="cupassword" placeholder="Enter Your current password" >
                    <input type="password" name="cnupassword" class="lock" placeholder=" new Password" >
